 ...
 *  future time.
 *
 *  Fixed registered trademark, copyright, euro, pound, and added yen.
 *  - Ryan Lederman <ryan.lederman@kayako.com> 2/15/2011
 *
...
class Html2Text
{
    ...
    public $search = array(
		...
		/**
		 * ---------------------------------------------
		 * MODIFIED BY VARUN SHOOR - SWIFT-565
		 * ---------------------------------------------
		 */
...
//        '',								// Unknown/unhandled entities
    ...
    private function _convert()
    {
		 ...
		 *
		 * SWIFT-1828 Missing backslashes on Quick Insert KB
		 *
		 */
        $text = trim($this->html);
